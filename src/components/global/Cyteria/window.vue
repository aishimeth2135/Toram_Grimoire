<template>
    <transition name="fade">
        <div class="window" v-show="visible" @click="closeWindow">
            <div class="container" @click.stop>
                <div class="top">
                    ...
                    <span class="buttons">
                        ...
                        <cy-button v-if="type == 'normal'" type="icon-only"
...
<script>
    ...
    import vuevy_button from "./button.vue";
