...
class CharacterStatFormula {
    ...
    calc(simple_stats, vars){
        ...
        function handleVar(from, var_str, def_v, is_object=false){
            ...
            f = f
                ...
                .replace(/\#([a-zA-Z0-9_.]+)/g, (m, m1) => {
                    if ( ['cvalue', 'mvalue', 'tvalue'].includes(m1) ){
                        ...
                        switch (m1){
                            case 'cvalue': return cvalue;
                            case 'mvalue': return mvalue;
                            case 'tvalue': return tvalue;
                        }
                    }
                    return handleVar(vars.value['#'], m1, '0');
                });
        ...
        conditions.filter(p => p.statBasePart != null).forEach(p => {
            ...
            switch (t){
                case 'cvalue': cvalue += v; break;
                case 'mvalue': mvalue += v; break;
                case 'tvalue': tvalue += v; break;
            }
        });
