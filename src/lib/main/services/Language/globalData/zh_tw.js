export default function() {
  return {
    ...
    'Settings': {
      ...
      'night mode': {
        'title': '夜間模式',
        'caption': '如果喜歡黑色為主色的介面，可以切換成夜間模式。',
      },
      'switch font': {
        'title': '更改字體',
      ...
      'set rem': {
        'title': '調整頁面大小',
        'caption': '可以手動設定頁面的距離單位，來等比例調整頁面所有元素的大小。',
        'rem title': '距離單位',
        'tips 1': '可調整範圍為120~200，預設值為160。',
      },
      'language': {
        'title': '語言設定',
        'caption': '可選擇頁面顯示的語言，一般情況下不必特別設定。',
        'tips 1': '設定完畢後，頁面需重新整理方得生效。',
        'tips 2': '尚未翻譯的部分依然會顯示其他語言。',
        'button texts': {
          'lang auto': '自動判定',
          'lang 0': 'English',
          'lang 1': '繁體中文',
      ...
      'second language': {
        ...
        'tips 1': '設定完畢後，頁面需重新整理方得生效。',
        'tips 2': '若第二優先級語言依然沒有翻譯，則會顯示原始資料（一般而言是繁體中文）。',
      },
      'clear caches of spreadsheets': {
        ...
        'tips 1': '一般情況下，也不用特別使用這個功能。當較舊的資料庫資料會導致程式無法正常運作時，才必須使用此功能。。',
