...
const createCustomEquipment = (type: EquipmentTypes) => {
  ...
  const equipment = characterStore.appendEquipment(newEquip)
  if (equipment) {
        ...
        <div class="space-y-2.5 px-2 py-3">
          ...
          >
            <div
              v-for="item of types"
              :key="item"
              class="border-primary-10 hover:border-primary-40 m-1.5 flex h-12 w-12 cursor-pointer items-center justify-center rounded-full border-2 duration-150"
              hover
