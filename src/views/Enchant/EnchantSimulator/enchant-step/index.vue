...
<template>
  ...
  >
    <div class="flex items-center border-b py-0.5 pl-2" :class="[mainBorderColor]">
      ...
      <div class="mr-1 ml-auto inline-flex items-center">
        ...
        />
        <cy-button-icon icon="jam-close-circle" class="p-0 text-gray-60" @click="step.remove()" />
      </div>
    </div>
    <div class="p-1">
    ...
    <div class="mt-auto border-t border-fuchsia-60 pt-0.5">
      ...
      <div class="flex items-center py-0.5">
        ...
        <cy-button-icon
          ...
          @click="step.autoFill()"
        />
        <div class="mr-2 ml-auto inline-flex items-center gap-icon text-fuchsia-60">
