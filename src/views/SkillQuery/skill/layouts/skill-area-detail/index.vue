      ...
      <div>
        ...
        <div class="flex justify-center text-sm">
          <div class="flex items-center">
            <cy-icon icon="bx-bxs-circle" class="mr-1 text-blue-60" small />
            {{ t('skill-query.branch.skill-area.point: character') }}
          </div>
          <div class="ml-2.5 flex items-center">
            <cy-icon icon="bx-bxs-circle" class="mr-1 text-orange-60" small />
        ...
        <table>
          <tbody>
            <tr v-for="key in displayAttrsKeys" :key="key">
              <td class="border-r-2 border-primary-20 pr-2 text-right text-gray-50">
