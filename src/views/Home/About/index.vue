      ...
      >
        ...
        >
          <div class="mb-4 mr-3 shrink-0 rounded-full" @click="navigate">
            <div class="text-primary-70 px-4">
        ...
        <div class="pl-4 pr-2 pt-2">
          <template v-if="column.title === 'partnership'">
            <div class="relative w-96 rounded-b-lg shadow-lg">
              ...
              <div class="bg-primary-20 flex w-full items-center rounded-b-lg px-4 py-2.5">
                <div class="overflow-hidden rounded-sm">
                  <img :src="discordGroupData.iconUrl" alt="#" width="50" height="50" />
                </div>
                <div class="pl-4">
                  <div class="text-primary-90 text-xl">Toram's Pelulu</div>
                  <div class="text-fuchsia-80 flex items-center text-sm">
          ...
          <template v-else>
            ...
            <div class="space-y-2 pb-2">
              <div v-for="item in column.list" :key="item.title">
                <div v-if="!item.title.startsWith('@')" class="text-primary-50 text-sm">
                ...
                <div class="py-2 pl-4">
                  ...
                  >
                    ...
                    <span
                      ...
                      "
                    >
                      <div class="bg-primary-30 absolute left-0 top-1 h-2 w-2 rounded-full" />
