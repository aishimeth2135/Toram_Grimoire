  ...
  <AppLayoutMain>
    <section class="space-y-4 px-3">
      <div
        ...
        :key="column.title"
        class="cy--about-column flex overflow-x-auto rounded-md border-2 border-transparent bg-white p-4 duration-200 hover:border-primary-30"
      >
        <router-link
          ...
          custom
        >
          <div class="mr-3 mb-4 shrink-0 rounded-full" @click="navigate">
        ...
        <div v-else class="mr-3 mb-4 shrink-0 rounded-full">
          <div class="px-4 text-primary-70">
            {{ t(`app.about.${column.title}.title`) }}
          </div>
          <div class="mt-0.5 h-1 rounded-full bg-primary-30" />
        ...
        <div class="pt-2 pr-2 pl-4">
          <template v-if="column.title === 'partnership'">
            <div class="relative w-96 rounded-b-lg shadow-lg">
              ...
              />
              <cy-icon icon="mdi:discord" class="absolute top-2 right-2" width="2rem" />
              <div class="flex w-full items-center rounded-b-lg bg-primary-20 px-4 py-2.5">
                ...
                <div class="pl-4">
                  ...
                  <div class="flex items-center text-sm text-fuchsia-80">
                    <cy-icon class="mr-1 text-fuchsia-50" icon="ic:baseline-person" small />
          ...
          <template v-else>
            <div class="mb-6 text-sm text-gray-60">
              ...
              <div v-for="item in column.list" :key="item.title">
                ...
                <div class="py-2 pl-4">
                  ...
                  >
                    ...
                    <span
                      v-else
                      class="relative inline-flex pr-3 pl-4"
                      :class="
                      ...
                      "
                    >
                      <div class="absolute top-1 left-0 size-2 rounded-full bg-primary-30" />
                      ...
                      <span v-else class="inline-flex flex-wrap items-center">
                        ...
                        <span class="ml-2 text-sm text-blue-40">
                          {{ value.sub }}
                        </span>
                      </span>
                    </span>
          ...
          <div v-if="column.title === 'author'" class="mt-3 px-3">
            ...
            >
              ...
              <span
                class="ml-3 inline-flex items-center rounded-lg border-2 border-cyan-60/50 py-0.5 pr-4 pl-2"
              >
