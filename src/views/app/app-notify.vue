    ...
    <div class="z-100 fixed bottom-14 right-5 w-80" style="max-width: calc(100vw - 2rem)">
      <transition-group name="fade-slide">
        ...
        >
          <span
            v-if="msg.counter > 1"
            class="border-primary-30 bg-primary-90 text-primary-30 absolute -right-4 -top-4 inline-flex size-8 items-center justify-center rounded-full border border-solid"
          >
