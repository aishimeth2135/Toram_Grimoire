...
function DataPath(id: DataPathIds): string {
  switch (id) {
    ...
    case DataPathIds.EquipmentTrait:
      return 'https://docs.google.com/spreadsheets/d/e/2PACX-1vS_XhF85gZ5sd9AtOMSM6JY4OuQwFlD6kToQynQ4bMq_fiaUNr26c7dbrIs6WeWnscKe1rau1npWYe7/pub?gid=1482085643&single=true&output=csv&range=A:F'
  }
}
