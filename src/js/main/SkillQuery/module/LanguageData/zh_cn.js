    ...
    return {
        ...
        'Skill Query': {
            ...
            "Analysis Skill": {
                ...
                'magic': '魔法',
                'normal attack': '一般攻击',
                'damage poration type: none': '不受惯性影响',
                'effective poration type: none': '不影响惯性',
                'damage poration: title': '伤害惯性',
                'effective poration: title': '造成惯性',
                'element: neutral': '无属性',
                'element: fire': '火属性',
                'element: water': '水属性',
                'element: earth': '地属性',
